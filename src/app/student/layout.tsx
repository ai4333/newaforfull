        ...
        <div className="dash-layout">
            ...
            <aside className="dash-sidebar">
                <div style={{ paddingBottom: '20px', borderBottom: '1px solid rgba(139,30,43,0.08)' }}>
                    <h1 className="fraunces text-ink" style={{ fontSize: '1.25rem', fontWeight: 900, letterSpacing: '0.05em' }}>AforPrint</h1>
                    ...
                    <header style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            <div style={{ textAlign: 'right' }}>
                                <div className="nav-text" style={{ fontSize: '11px', fontWeight: 700 }}>Nikhil Sridhara</div>
                                <div className="label" style={{ fontSize: '8px', opacity: 0.5 }}>ID: 2025-4432</div>
                            </div>
                            <div className="founder-monogram" style={{ width: '32px', height: '32px', fontSize: '12px' }}>N</div>
                        </div>
                    </header>
