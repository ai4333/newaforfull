...
export default function VendorLayout({ children }: { children: React.ReactNode }) {
    ...
    const [shopName, setShopName] = useState("University Print Hub");
                ...
                <header style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                        <div style={{ textAlign: 'right' }}>
                            <div className="nav-text" style={{ fontSize: '12px', fontWeight: 700 }}>Manager Console</div>
                            <div className="label" style={{ fontSize: '9px', opacity: 0.5 }}>Online & Accepting</div>
                        </div>
                        <button
